  ...
  // Tier 4
  {
    ...
    fill: {
      ...
      gradientPairs: [
       ...
       ["#e03636","#e34849"],
       ["#e03636","#e34849"],
       ["#e03636","#ff8636"],  // red → orange
       
       ["#ff8636","#ff8636"],
       ["#ff8636","#ff8636"],
       ["#ff8636","#fef72c"],  // orange → yellow

      ["#fef72c","#fef72c"],
      ["#fef72c","#fef72c"],
      ["#fef72c","#77ff23"],  // yellow → light-green

      ["#77ff23","#77ff23"],
      ["#77ff23","#77ff23"],
      ["#77ff23","#39c65c"],  // light-green → green

      ["#39c65c","#39c65c"],
      ["#39c65c","#39c65c"],
      ["#39c65c","#68afe3"],  // green → light-blue

      ["#68afe3","#68afe3"],
      ["#68afe3","#68afe3"],
      ["#68afe3","#3699f8"],  // light-blue → blue

      ["#3699f8","#3699f8"],
      ["#3699f8","#3699f8"],
      ["#3699f8","#4a45ff"],  // blue → violet

      ["#4a45ff","#4a45ff"],
      ["#4a45ff","#4a45ff"],
      ["#4a45ff","#b336f8"],  // violet → purple

      ["#b336f8","#b336f8"],
      ["#b336f8","#b336f8"],
      ["#b336f8","#d736af"],  // purple → magenta

      ["#d736af","#d736af"],
      ["#d736af","#d736af"],
      ["#d736af","#d736af"],
      ["#d736af","#e03636"]   // magenta → red (wrap-around)
    ]
    },
    stroke: {
      show: true,
